...
class ed_methods_test_26_dict(unittest.TestCase):
    ...
    def test_words_by_letter(self):
        ...
        self.assertEqual(words_by_letter['c'], {"coxed", "darcy", "ratch", "xebec"})
        self.assertEqual(words_by_letter['d'], {"admen", "bandy", "coxed", "darcy", "edges", "ideas"})
        self.assertEqual(words_by_letter['e'], {"admen", "coxed", "edges", "haver", "ideas", "lunet", "ozzie", "quine", "saute", "ulema", "xebec"})
        self.assertEqual(words_by_letter['f'], {"foins"})
        self.assertEqual(words_by_letter['g'], {"edges", "goops"})
